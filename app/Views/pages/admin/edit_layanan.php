        ...
        <div id="main">
            ...
            <div class="page-heading">
                ...
                <?php foreach ($layanan as $j) : ?>
                    <form method="post" action="<?php echo base_url('Admin/' . $j['id'] . '/update_layanan') ?>" class="form-horizontal" role="form">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="provinsi" placeholder="Enter provinsi" value="<?= $j['provinsi']; ?>">
                                            </div>

                                            <div class="form-group">
                                                <label for="kabupaten">Kabupaten</label>
                                                <input type="text" class="form-control" name="kabupaten" placeholder="Enter kabupaten" value="<?= $j['kabupaten']; ?>">
                                            </div>

                                            <div class="form-group">
                                                <label for="kecamatan">Kecamatan</label>
                                                <input type="text" class="form-control" name="kecamatan" placeholder="Enter kecamatan" value="<?= $j['kecamatan']; ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="kelurahan">Kelurahan</label>
                                                <input type="text" class="form-control" name="kelurahan" placeholder="Enter kelurahan" value="<?= $j['kelurahan']; ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="jenis permohonan">Permohonan KTP</label>
                                                <select name="jenis_permohonan" class="form-control" value="<?= $j['jenis_permohonan']; ?>">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="nama" placeholder="Enter nama " value="<?= $j['nama']; ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="kk">No KK</label>
                                                <input type="text" class="form-control" name="kk" placeholder="Enter No KK" value="<?= $j['kk']; ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="nik">NIK</label>
                                                <input type="text" class="form-control" name="nik" placeholder="Enter NIK" value="<?= $j['nik']; ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="alamat">Alamat</label>
                                                <input type="text" class="form-control" name="alamat" placeholder="Enter alamat" value="<?= $j['alamat']; ?>">
                                            </div>
                                        </div>
                                        <br>
