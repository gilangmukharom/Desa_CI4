        ...
        <div id="main">
            ...
            <div class="page-heading">
                ...
                <?php foreach ($aduan as $k) : ?>
                    <form method="post" action="<?php echo base_url('Admin/' . $k['id'] . '/update_aduan') ?>" class="form-horizontal" role="form">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-12 mb-1">
                                            ...
                                            <div class="form-group has-icon-left ">
                                                ...
                                                <div class="position-relative">
                                                    <input type="date" class="form-control py-2" placeholder="Tanggal" id="date" name="date" value="<?= $k['date']; ?>" />
                                                    <div class="form-control-icon">
                                            ...
                                            <div class="form-group has-icon-left ">
                                                ...
                                                <div class="position-relative">
                                                    <select name="kategori" class="form-control" id="kategori" value="<?= $k['kategori']; ?>">
                                            ...
                                            <div class="form-group mandatory ">
                                                <div class="position-relative">
                                                    ...
                                                    <div class="form-outline  mb-4">
                                                        <textarea class="form-control" id="body" name="body" rows="3" value="<?= $k['body']; ?>"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12 mb-1">
                                            <div class="form-group ">
                                                <div class="position-relative">
                                                    ...
                                                    <input type="file" class="image-preview-filepond" id="image" name="image" value="<?= $k['image']; ?>" />
