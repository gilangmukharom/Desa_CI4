                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            <div class="d-flex justify-left-end mt-6">
                                <a href="<?php echo base_url('User/create_aduan') ?>" class="btn btn-success mb-2 btn-pill ">Tambah Aduan</a>
                            </div>
                        </div>
                        <div class="card-body">
                                    ...
                                    <?php foreach ($aduan as $k) : ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?php echo base_url('User/' . $k['id'] . '/edit_aduan') ?>" class='btn btn-warning btn-s'>Edit</a>
