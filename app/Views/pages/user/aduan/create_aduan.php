    ...
    <div id="app">
        ...
        <div id="main">
            ...
            <div class="page-heading">
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            <h3>Buat Aduan Anda</h3>
                            <p class="text-subtitle text-muted">Laporkan aduan yang anda miliki terkait pemerintah Desa Bandungsari..</p>
                        </div>
                ...
                <hr>
                <div class="mb-5">
                    <a data-bs-toggle="tooltip" data-bs-original-title="Kembali ke halaman sebelumnya." href="admin.php" class="btn btn-secondary px-3 pt-2 me-2">
                        <span class="fa-fw fa-lg select-all fas text-white"><i class="bi-arrow-left text-white"></i></span>
                    </a>
                </div>
                <!-- Input SKTP -->
                <form method="post" action="<?php echo base_url('User/save') ?>" class="form-horizontal" role="form">
                    ...
                    <section class="section">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Buat keluhan Anda</h4>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6 col-12 mb-1">
                                        <div class="form-group has-icon-left ">
                                            ...
                                            <div class="position-relative">
                                                <input type="text" class="form-control py-2" placeholder="Judul keluhan" id="judul" name="judul" required />
                                        ...
                                        <div class="form-group has-icon-left ">
                                            ...
                                            <div class="position-relative">
                                                <input type="date" class="form-control py-2" placeholder="Tanggal" id="date" name="date" />
                                                <div class="form-control-icon">
                                        ...
                                        <div class="form-group has-icon-left ">
                                            ...
                                            <div class="position-relative">
                                                <select name="kategori" class="form-control" required>
                                                    ...
                                                    <option value="2">Infraktruktur</option>
                                    ...
                                    <div class="col-md-6 col-12 mb-1">
                                        <div class="form-group has-icon-left ">
                                            ...
                                            <div class="position-relative">
                                                <input type="text" class="form-control py-2" placeholder="Nama Pengadu" id="nama" name="nama" required />
                                                <div class="form-control-icon">
                                                    <i class="bi bi-card-heading py-2"></i>
                                                </div>
                                                <div class="parsley-error filled" id="parsley-id-1" aria-hidden="false">
                                        ...
                                        <div class="form-group has-icon-left ">
                                            ...
                                            <div class="position-relative">
                                                <input type="text" class="form-control py-2" placeholder="RT/RW" id="alamat" name="alamat" required />
                                                <div class="form-control-icon">
                                                    <i class="bi bi-card-heading py-2"></i>
                                                </div>
                                                <div class="parsley-error filled" id="parsley-id-1" aria-hidden="false">
                                        ...
                                        <div class="form-group has-icon-left ">
                                            ...
                                            <div class="position-relative">
                                                <input type="text" class="form-control py-2" placeholder="NIK" id="nik" name="nik" required />
                                                <div class="form-control-icon">
                                                    <i class="bi bi-card-heading py-2"></i>
                                                </div>
                                                <div class="parsley-error filled" id="parsley-id-1" aria-hidden="false">
                                    ...
                                    <div class="d-flex justify-left-end mt-6">
                                        ...
                                        &nbsp;&nbsp;
                                        <a href="./admin.php?hlm=user" class="btn btn-danger mb-2 btn-pill ">Batal</a>
                                    </div>
                                    <br>
                                </div>
                            </div>
