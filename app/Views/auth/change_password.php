    ...
    <div id="app">
            ...
            <div class="sidebar-wrapper active">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item  ">
                            <a href="<?php echo base_url('Admin/aduan') ?>" class='sidebar-link'>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton" style="min-width: 11rem;">
                                    ...
                                    <li><a class="dropdown-item" href="logout.php"><i class="icon-mid bi bi-box-arrow-left me-2"></i> Keluar</a></li>
        ...
        <div id="main">
            ...
            <div class="page-heading">
                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="profile_user">Akun</a></li>
                ...
                <form method="post" action="<?php echo base_url('Auth/changePassword') ?>" class="form-horizontal" role="form">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6 col-12 mb-1">
                                        <div class="form-group has-icon-left">
                                            ...
                                            <div class="position-relative">
                                                <input type="password" class="form-control py-2" placeholder="password lama" id="password" name="password" maxlength="255" required />
                                    ...
                                    <div class="col-md-6 col-12 mb-1">
                                        <div class="form-group has-icon-left ">
                                            ...
                                            <div class="position-relative">
                                                <input type="password" class="form-control py-2" placeholder="password baru" id="new_password" name="new_password" maxlength="255" required />
                                                <div class="form-control-icon">
                                    ...
                                    <div class="col-md-6 col-12 mb-1">
                                        <div class="form-group has-icon-left ">
                                            ...
                                            <div class="position-relative">
                                                <input type="password" class="form-control py-2" placeholder="konfirmasi password" id="confirm_password" name="confirm_password" maxlength="255" required />
                                                <div class="form-control-icon">
                                                    <i class="bi bi-key-fill py-2"></i>
                                                </div>
                                                <div class="invalid-feedback d-block">
                                ...
                                <div class="row">
                                    <div class="col-12 mt-3 d-flex justify-content-start">
                                        <button type="submit" value="Change Password" class="btn btn-primary me-1 mb-1">
                                            Submit
                                        </button>
                                    </div>
                                </div>
